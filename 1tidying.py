...
# ===== タイプ別リンク（★ここをクライアント様の実際のURLに変更） =====
TYPE_LINKS = {
    'freeze': 'https://yourdomain.com/freeze-lp',   # 思考フリーズタイプ用
    'emotion': 'https://yourdomain.com/emotion-lp', # 感情ためこみタイプ用
    'burnout': 'https://yourdomain.com/burnout-lp', # 一気に燃え尽きタイプ用
    'family': 'https://yourdomain.com/family-lp',   # 散らかされタイプ用
}
...
if submitted: 
    ...
    st.markdown("▼あなたにぴったりのアドバイスはこちらから👇") 
    st.markdown(f"[📩 無料アドバイスを受け取る]({TYPE_LINKS[top_type]})")
