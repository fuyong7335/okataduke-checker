...
questions = [
    ...
    ("Q9. 片付けについてよく調査することは？", [
        ...
        ("ビフォーアフターの写真や時短掃除法", 'burnout'),
        ("家族がちらかさない仕組みづくり", 'family')
    ]),
    ("Q10. あなたの中で片付けのテーマは？", [
        ("決断力をつけること", 'freeze'),
        ("感情と向き合うこと", 'emotion'),
